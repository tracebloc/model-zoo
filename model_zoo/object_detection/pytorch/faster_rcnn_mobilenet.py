...
seed is hosted (an internal ticket is blocked on the store decision in
the hosting decision). So every run of this template to date trained with no backbone
...
belongs to the hosting decision / (internal ref), not to this file. The trade taken here
