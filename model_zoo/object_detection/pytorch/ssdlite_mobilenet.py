...
upload the matched ``ssdlite_mobilenet_weights.pkl`` sitting next to this
file via ``weights=True``, and the platform loads it after ``MyModel()``
has built this architecture::
