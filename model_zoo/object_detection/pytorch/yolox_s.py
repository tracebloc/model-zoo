...
transform's configured resolution family-wide, and
...
(internal ref) it hands this model label space ``[1, C]``: the platform's
...
, so there is no official checkpoint whose running statistics
