...
SEED_EXCLUDED_PREFIXES = ("class_embed.0.", "class_embed.1.", "class_embed.2.", "class_embed.3.", "class_embed.4.", "class_embed.5.", "model.decoder.class_embed.0.", "model.decoder.class_embed.1.", "model.decoder.class_embed.2.", "model.decoder.class_embed.3.", "model.decoder.class_embed.4.", "model.decoder.class_embed.5.", "model.denoising_class_embed.", "model.enc_score_head.")
