...
def MyModel(num_classes=output_classes):
    ...
    # match faster_rcnn_resnet and the rest of this family — a federated edge
    # trains at batch sizes where BN running statistics are the dominant noise
    # source, and frozen stats also average cleanly across clients.
