...
- **Input**: text strings; tokenization happens inside the training container with the tokenizer each template names in `tokenizer_file` (uploaded with the model — see [`../TOKENIZERS.md`](../TOKENIZERS.md)).
