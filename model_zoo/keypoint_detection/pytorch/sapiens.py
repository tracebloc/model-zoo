...
# `_run_direct_step`, and `_SapiensWrapper.forward` returns an
# `(N, K, 3)` tensor of `[x, y, confidence]` in pixel space.
#
# ⚠️ NOT `heatmap`, even though this is a transformer backbone: the head is an
# `nn.Linear` regressing coordinates directly, with no heatmap anywhere.
