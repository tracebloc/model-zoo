...
an internal ticket's acceptance, and the thing the old verifier could not ask. That one
...
acceptance run happened at some OTHER class count.
...
* ``missing`` keys     ⇒ allowed ONLY where the template declared them via
                         ...
                         (internal ref) silent-drop, and it fails here.
