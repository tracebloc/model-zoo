...
#
# 61 -> 62: backend#2982 Tier 2 added cascade_rcnn — three sequentially-refined
# R-CNN heads at IoU 0.5/0.6/0.7 in place of torchvision's single-stage RoIHeads.
# NO_SEED for the same reason.
#
...
# siblings efficientdet_d0 and sparse_rcnn. The first to land is 62; after that
# the number is whatever the tool reports against the merged tree. RE-READ IT,
# DO NOT ADD — a rebase that keeps this branch's literal goes green locally and
# red on develop.
