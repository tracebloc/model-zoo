...
#
# 61 -> 62: backend#2982 Tier 2 added efficientdet_d0 — a from-scratch
# EfficientNet-B0 trunk under a BiFPN with learnable weighted fusion, and shared
# separable class/box heads. NO_SEED for the same reason.
#
...
# siblings cascade_rcnn (#242) and sparse_rcnn. The first to land is 62; after
# that the number is whatever the tool reports against the merged tree. RE-READ
# IT, DO NOT ADD — a rebase that keeps this branch's literal goes green locally
# and red on develop.
