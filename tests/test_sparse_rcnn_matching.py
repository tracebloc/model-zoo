...
def test_the_backbone_matches_torchvisions_faster_rcnn_backbone():
    ...
    ``FrozenBatchNorm2d``, which holds weight and bias as buffers. (internal ref)
...
def test_no_trainable_parameter_is_unreachable_by_the_loss():
    ...
    values are parameters since (internal ref), not buffers. The
