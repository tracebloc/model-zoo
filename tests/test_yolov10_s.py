...
def guard_attention_matches_the_manual_formula(module) -> None:
    ...
    ``tests/test_sdpa_equivalence.py`` is the acceptance bar (internal ref) set
...
.
    ...
    assert not uncovered, (
        ...
        f"shape mismatch (internal ref) exists to remove. NOTE this template's "
